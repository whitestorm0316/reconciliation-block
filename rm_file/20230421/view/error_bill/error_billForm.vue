    ...
    <div class="gva-form-box">
      <el-form :model="formData" ref="elFormRef" label-position="right" :rules="rule" label-width="80px">
        ...
        <el-form-item label="对账员ID:" prop="reconciler">
          <el-select v-model="formData.reconciler" placeholder="请选择" :clearable="true">
            <el-option v-for="(item,key) in intOptions" :key="key" :label="item.label" :value="item.value" />
          </el-select>
        </el-form-item>
        <el-form-item label="审核员ID:" prop="reviewer">
          <el-select v-model="formData.reviewer" placeholder="请选择" :clearable="true">
            <el-option v-for="(item,key) in intOptions" :key="key" :label="item.label" :value="item.value" />
          </el-select>
        </el-form-item>
        ...
        <el-form-item label="本地账单ID:" prop="localBillId">
          <el-select v-model="formData.localBillId" placeholder="请选择" :clearable="true">
            <el-option v-for="(item,key) in intOptions" :key="key" :label="item.label" :value="item.value" />
          </el-select>
        </el-form-item>
        <el-form-item label="第三方账单ID:" prop="thirdPartyBillId">
          <el-select v-model="formData.thirdPartyBillId" placeholder="请选择" :clearable="true">
            <el-option v-for="(item,key) in intOptions" :key="key" :label="item.label" :value="item.value" />
          </el-select>
        </el-form-item>
        <el-form-item>

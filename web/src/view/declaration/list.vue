<template>
  ...
  <el-table :data="tableData">
        ...
        <el-table-column align="left" label="操作" width="160">
          <template #default="scope">
            <el-button icon="edit" type="primary" link @click="updateBill(scope.row)">编辑</el-button>
...
const getTableData = async() => {
  console.log(page)
  const table = await getBillList({ page: page.value, pageSize: pageSize.value, keyword: userStore.userInfo.ID.toString(),keyType: "initiatorID"})
  if (table.code === 0) {
